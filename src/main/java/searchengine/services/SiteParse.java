...
public class SiteParse implements Runnable {
 ...
 //   private static ConcurrentLinkedQueue<ForkJoinPool> poolList = new ConcurrentLinkedQueue<>();
    ...
    public SiteParse copy() {
        return new SiteParse(this.pageModelRepository, this.siteModelRepository, this.lemmaModelRepository, this.indexModelRepository/*, this.lemmaParser*/);
    }
    ...
    public void run() {
        ...
        result.append(pool.invoke(new PageParse(url, 0, siteModel)));
    }
